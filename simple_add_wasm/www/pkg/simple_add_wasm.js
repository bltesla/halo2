...
* @returns {Uint8Array}
*/
export function create_simple_add_proof_wasm(k, a, b) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.create_simple_add_proof_wasm(retptr, k, a, b);
...
* @returns {boolean}
*/
export function verify_simple_add_proof_wasm(k, a, b, proof) {
    const ptr0 = passArray8ToWasm0(proof, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.verify_simple_add_proof_wasm(k, a, b, ptr0, len0);
    return ret !== 0;
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('simple_add_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
